...
VALUES
  ...
  ('Magallanes y de la Antártica Chilena') ON CONFLICT DO NOTHING;

INSERT INTO
  provincia (nom_provincia, cod_region)
VALUES
  ('Arica', 1),
  ('Parinacota', 1),
  ('Iquique', 2),
  ...
  ('Magallanes', 16),
  ('Tierra del Fuego', 16),
  ('Antártica Chilena', 16) ON CONFLICT DO NOTHING;

INSERT INTO
  comuna (nom_comuna, cod_provincia)
VALUES
  ('Arica', 1),
  ('Camarones', 1),
  ('General Lagos', 2),
  ...
  ('Timaukel', 55),
  ('Cabo de Hornos', 56),
  ('Antártica', 56) ON CONFLICT DO NOTHING;


-- CREAR ELEMENTOS PATRIMONIO INMATERIAL
INSERT INTO patrimonio_inmaterial (nombre_elemento) VALUES 
...
('Cestería Yagan'),
('Circo Tradicional en Chile'),
('Modo de vida asociado a las labores del campo en Torres del Paine') ON CONFLICT DO NOTHING;

INSERT INTO ambito_patrimonio (ambito) VALUES 
('Artes del espectáculo'),
('Conocimientos y usos relacionados con la naturaleza y el universo'),
('Técnicas Artesanales tradicionales'),
('Tradiciones y Expresiones Orales'),
('Usos sociales, rituales y actos festivos') ON CONFLICT DO NOTHING;
